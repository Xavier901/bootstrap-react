                ...
                <div className="row justify-content-center">
                    ...
                    <div className="col-md-5 col-lg-4">
                        <div className="clean-pricing-item">
                            ...
                            <div className="price">
                                <h4>$50</h4>
                            </div><button className="btn btn-primary d-block w-100" type="button">BUY NOW</button>
                        </div>
                    </div>
                    <div className="col-md-5 col-lg-4">
                        <div className="clean-pricing-item">
                            ...
                            <div className="price">
                                <h4>$150</h4>
                            </div><button className="btn btn-outline-primary d-block w-100" type="button">BUY NOW</button>
                        </div>
                    </div>
                </div>
            </div>
